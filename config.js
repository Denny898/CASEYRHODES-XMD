...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Caseyrhodes~jAgzmYgK#74mEhdMfFsBmaGCJmtpXCCKdKPt_YLpswQAV7rCnM0A",
// add your Session Id 
...
OWNER_NAME: process.env.OWNER_NAME || "𝐷𝐵𝑌✯",//add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*𝐷𝐵𝑌✯✦*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.imgur.com/PEZ5QL2.jpeg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> 𝐷𝐵𝑌✯ Md IS SPARKING ACTIVE AND ALIVE\n\n\nKEEP USING 𝐷𝐵𝑌✯ Md  FROM DENBOY TECH INC⚡",
// add alive msg here 
